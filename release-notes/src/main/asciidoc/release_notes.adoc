...
== Features
Adding to the list of existing features: https://docs.fd.io/honeycomb/1.19.01/release-notes-aggregator/release_notes.html#_features[1901 feature list]

=== New features
* https://jira.fd.io/browse/HONEYCOMB-443[Bump ODL dependencies to Neon]
* https://jira.fd.io/browse/HONEYCOMB-449[Integrate java 11]
* https://jira.fd.io/browse/HONEYCOMB-450[Add support for Ubuntu 18.04 (Bionic Beaver)]
* https://jira.fd.io/browse/HONEYCOMB-192[Migrate Guava's Optional to Java8]
