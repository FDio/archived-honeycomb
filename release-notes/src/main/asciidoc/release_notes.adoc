...
* https://jira.fd.io/browse/HONEYCOMB-402[Support for IPv6 BGP Peers]
* https://jira.fd.io/browse/HONEYCOMB-423[BGP configuration read via Netconf]
* https://jira.fd.io/browse/HONEYCOMB-424[ODL Oxygen]
