...
== Features
Adding to the list of existing features: https://docs.fd.io/honeycomb/1.18.04/release-notes-aggregator/release_notes.html#_features[1801 feature list]

=== New features

* https://jira.fd.io/browse/HONEYCOMB-439[ODL Oxygen SR2]
