...
== Features
Adding to the list of existing features: https://docs.fd.io/honeycomb/1.18.10/release-notes-aggregator/release_notes.html#_features[1810 feature list]

=== New features

* https://jira.fd.io/browse/HONEYCOMB-448[Prepare migration to JAVA 11]
