...
* https://jira.fd.io/browse/HONEYCOMB-372[Optimize ODL dependencies] - another footprint related optimization,
which provides whitelist of ODL's YANG modules exposed by HC.

=== Removed features

=== Modified features
* https://jira.fd.io/browse/HONEYCOMB-386[WriterCustomizer's update is optional] - added generic update support as
delete + create on infra level.
