...
License:    Apache-1.0
URL:        http://www.fd.io
Source0:     vpp-integration-distribution-%{_version}-RC0-hc.zip
...
%autosetup -n vpp-integration-distribution-%{_version}-RC0

%install
# Create directory in build root for Honeycomb
mkdir -p $RPM_BUILD_ROOT/opt/%name
# Copy Honeycomb from archive to its dir in build root
cp -r ../vpp-integration-distribution-%{_version}-RC0/* $RPM_BUILD_ROOT/opt/%name
