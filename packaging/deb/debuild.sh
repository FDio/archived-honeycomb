...
ARCHIVE=${ARCHIVE_DIR}/vpp-integration-distribution-1.16.9-RC0-hc.tar.gz
cp ${ARCHIVE} ${DIR}
ARCHIVE=${DIR}/vpp-integration-distribution-${VERSION}-RC0-hc.tar.gz
...
mv ${DIR}/vpp-integration-distribution-${VERSION}-RC0/ ${PACKAGING_ROOT}/
...
vpp-integration-distribution-${VERSION}-RC0/* /opt/honeycomb/
